...
### Створити специфікацію обмежень для системи (наприклад, "кожен користувач має хоча б одну задачу" або "кожна задача може входити лише до одного списку") та перевірити її коректність в Alloy.
